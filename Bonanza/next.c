    ...
    case next_move_hash:
	    ...
	    for ( i = 0; i < n; i++ ){
	        ...
	        if ( move == move_hash ){ 
		        ...
		        killer1 = 0;
		        value = ptree->amove_killer[ply].no1_value + p_value_ex[15U+UToCap(move)];
		        if ( sortv < value ) { 
                    sortv = value; 
                }
		        if ( sortv > -1 ) { 
		        ...
		        killer2 = 0;
		        value = ptree->amove_killer[ply].no2_value + p_value_ex[15U+UToCap(move)];
		        if ( sortv < value ){ 
                    sortv = value; 
                }
		        if ( sortv > -1 ){ 
