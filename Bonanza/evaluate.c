...
static int ehash_probe( uint64_t current_key, unsigned int hand_b,int *pscore );
static void ehash_store( uint64_t key, unsigned int hand_b, int score );
static int make_list( const tree_t * restrict ptree, int * restrict pscore,int list0[52], int list1[52] );
